// public/js/app.js
import { renderLandingPage } from './pages/landing.js?v=20260916c';
import { renderLoginPage } from './pages/login.js?v=20260916c';
import { renderDashboardPage, loadDashboardJogos } from './pages/dashboard.js?v=20260916c';
import { renderAgendaPage } from './pages/agenda.js?v=20260916c';
import { renderEquipesPage } from './pages/admin/equipes.js?v=20260916c';
import { renderModalidadesPage } from './pages/admin/modalidades.js?v=20260916c';
import { renderJogoEditorPage } from './pages/admin/jogo_editor.js?v=20260916c';
import { renderSumulaEditorPage } from './pages/admin/sumula_editor.js?v=20260916c';
import { renderLiderDashboardPage } from './pages/lider_dashboard.js?v=20260916c';
import { renderArbitroDashboardPage, loadArbitroJogos } from './pages/arbitro_dashboard.js?v=20260916c';
import { renderEquipesPublicPage } from './pages/equipes.js?v=20260916c';
import { renderResultadosPage } from './pages/resultados.js?v=20260916c';
import { renderRankingPage } from './pages/ranking.js?v=20260916c';
import { renderSobrePage } from './pages/sobre.js?v=20260916c';
import { renderTermosPage } from './pages/termos.js?v=20260916c';
import { renderRegulamentoPage } from './pages/regulamento.js?v=20260916c';
import { renderRegulamentosAdminPage } from './pages/admin/regulamentos.js?v=20260916c';
import { renderTvVideosAdminPage } from './pages/admin/tv_videos.js?v=20260916c';
import { renderMinhasInscricoesPage } from './pages/minhas_inscricoes.js?v=20260916c';
import { loginUser, logoutUser, currentUser, authResolved } from './auth.js?v=20260916c';
import { seedInitialData, getCollectionCount } from './services/db.js?v=20260916c';
