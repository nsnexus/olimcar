// public/js/app.js
import { renderLandingPage } from './pages/landing.js?v=20260917b';
import { renderLoginPage } from './pages/login.js?v=20260917b';
import { renderDashboardPage, loadDashboardJogos } from './pages/dashboard.js?v=20260917b';
import { renderAgendaPage } from './pages/agenda.js?v=20260917b';
import { renderEquipesPage } from './pages/admin/equipes.js?v=20260917b';
import { renderModalidadesPage } from './pages/admin/modalidades.js?v=20260917b';
import { renderJogoEditorPage } from './pages/admin/jogo_editor.js?v=20260917b';
import { renderSumulaEditorPage } from './pages/admin/sumula_editor.js?v=20260917b';
import { renderLiderDashboardPage } from './pages/lider_dashboard.js?v=20260917b';
import { renderArbitroDashboardPage, loadArbitroJogos } from './pages/arbitro_dashboard.js?v=20260917b';
import { renderEquipesPublicPage } from './pages/equipes.js?v=20260917b';
import { renderResultadosPage } from './pages/resultados.js?v=20260917b';
import { renderRankingPage } from './pages/ranking.js?v=20260917b';
import { renderSobrePage } from './pages/sobre.js?v=20260917b';
import { renderTermosPage } from './pages/termos.js?v=20260917b';
...
import { renderDoacaoAdminPage } from './pages/admin/doacao.js?v=20260917b';
...
const routes = {
    ...
    '/admin/doacao': renderDoacaoAdminPage,
