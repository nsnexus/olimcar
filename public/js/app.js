// public/js/app.js
import { renderLandingPage } from './pages/landing.js?v=20260912c';
import { renderLoginPage } from './pages/login.js?v=20260912c';
import { renderDashboardPage, loadDashboardJogos } from './pages/dashboard.js?v=20260912c';
import { renderAgendaPage } from './pages/agenda.js?v=20260912c';
import { renderEquipesPage } from './pages/admin/equipes.js?v=20260912c';
import { renderModalidadesPage } from './pages/admin/modalidades.js?v=20260912c';
import { renderJogoEditorPage } from './pages/admin/jogo_editor.js?v=20260912c';
import { renderSumulaEditorPage } from './pages/admin/sumula_editor.js?v=20260912c';
import { renderLiderDashboardPage } from './pages/lider_dashboard.js?v=20260912c';
import { renderArbitroDashboardPage, loadArbitroJogos } from './pages/arbitro_dashboard.js?v=20260912c';
import { renderEquipesPublicPage } from './pages/equipes.js?v=20260912c';
import { renderResultadosPage } from './pages/resultados.js?v=20260912c';
import { renderRankingPage } from './pages/ranking.js?v=20260912c';
import { renderSobrePage } from './pages/sobre.js?v=20260912c';
import { renderTermosPage } from './pages/termos.js?v=20260912c';
import { renderRegulamentoPage } from './pages/regulamento.js?v=20260912c';
import { renderRegulamentosAdminPage } from './pages/admin/regulamentos.js?v=20260912c';
import { renderTvVideosAdminPage } from './pages/admin/tv_videos.js?v=20260912c';
import { renderMinhasInscricoesPage } from './pages/minhas_inscricoes.js?v=20260912c';
import { loginUser, logoutUser, currentUser, authResolved } from './auth.js?v=20260912c';
import { seedInitialData, getCollectionCount } from './services/db.js?v=20260912c';
