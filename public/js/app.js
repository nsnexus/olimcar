// public/js/app.js
import { renderLandingPage } from './pages/landing.js?v=20260916e';
import { renderLoginPage } from './pages/login.js?v=20260916e';
import { renderDashboardPage, loadDashboardJogos } from './pages/dashboard.js?v=20260916e';
import { renderAgendaPage } from './pages/agenda.js?v=20260916e';
import { renderEquipesPage } from './pages/admin/equipes.js?v=20260916e';
import { renderModalidadesPage } from './pages/admin/modalidades.js?v=20260916e';
import { renderJogoEditorPage } from './pages/admin/jogo_editor.js?v=20260916e';
import { renderSumulaEditorPage } from './pages/admin/sumula_editor.js?v=20260916e';
import { renderLiderDashboardPage } from './pages/lider_dashboard.js?v=20260916e';
import { renderArbitroDashboardPage, loadArbitroJogos } from './pages/arbitro_dashboard.js?v=20260916e';
import { renderEquipesPublicPage } from './pages/equipes.js?v=20260916e';
import { renderResultadosPage } from './pages/resultados.js?v=20260916e';
import { renderRankingPage } from './pages/ranking.js?v=20260916e';
import { renderSobrePage } from './pages/sobre.js?v=20260916e';
import { renderTermosPage } from './pages/termos.js?v=20260916e';
import { renderRegulamentoPage } from './pages/regulamento.js?v=20260916e';
import { renderRegulamentosAdminPage } from './pages/admin/regulamentos.js?v=20260916e';
import { renderTvVideosAdminPage } from './pages/admin/tv_videos.js?v=20260916e';
import { renderMinhasInscricoesPage } from './pages/minhas_inscricoes.js?v=20260916e';
import { loginUser, logoutUser, currentUser, authResolved } from './auth.js?v=20260916e';
import { seedInitialData, getCollectionCount } from './services/db.js?v=20260916e';
