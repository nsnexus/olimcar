// public/js/app.js
import { renderLandingPage } from './pages/landing.js?v=20260916a';
import { renderLoginPage } from './pages/login.js?v=20260916a';
import { renderDashboardPage, loadDashboardJogos } from './pages/dashboard.js?v=20260916a';
import { renderAgendaPage } from './pages/agenda.js?v=20260916a';
import { renderEquipesPage } from './pages/admin/equipes.js?v=20260916a';
import { renderModalidadesPage } from './pages/admin/modalidades.js?v=20260916a';
import { renderJogoEditorPage } from './pages/admin/jogo_editor.js?v=20260916a';
import { renderSumulaEditorPage } from './pages/admin/sumula_editor.js?v=20260916a';
import { renderLiderDashboardPage } from './pages/lider_dashboard.js?v=20260916a';
import { renderArbitroDashboardPage, loadArbitroJogos } from './pages/arbitro_dashboard.js?v=20260916a';
import { renderEquipesPublicPage } from './pages/equipes.js?v=20260916a';
import { renderResultadosPage } from './pages/resultados.js?v=20260916a';
import { renderRankingPage } from './pages/ranking.js?v=20260916a';
import { renderSobrePage } from './pages/sobre.js?v=20260916a';
import { renderTermosPage } from './pages/termos.js?v=20260916a';
import { renderRegulamentoPage } from './pages/regulamento.js?v=20260916a';
import { renderRegulamentosAdminPage } from './pages/admin/regulamentos.js?v=20260916a';
import { renderTvVideosAdminPage } from './pages/admin/tv_videos.js?v=20260916a';
import { renderMinhasInscricoesPage } from './pages/minhas_inscricoes.js?v=20260916a';
import { loginUser, logoutUser, currentUser, authResolved } from './auth.js?v=20260916a';
import { seedInitialData, getCollectionCount } from './services/db.js?v=20260916a';
