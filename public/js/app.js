// public/js/app.js
import { renderLandingPage } from './pages/landing.js?v=20260916d';
import { renderLoginPage } from './pages/login.js?v=20260916d';
import { renderDashboardPage, loadDashboardJogos } from './pages/dashboard.js?v=20260916d';
import { renderAgendaPage } from './pages/agenda.js?v=20260916d';
import { renderEquipesPage } from './pages/admin/equipes.js?v=20260916d';
import { renderModalidadesPage } from './pages/admin/modalidades.js?v=20260916d';
import { renderJogoEditorPage } from './pages/admin/jogo_editor.js?v=20260916d';
import { renderSumulaEditorPage } from './pages/admin/sumula_editor.js?v=20260916d';
import { renderLiderDashboardPage } from './pages/lider_dashboard.js?v=20260916d';
import { renderArbitroDashboardPage, loadArbitroJogos } from './pages/arbitro_dashboard.js?v=20260916d';
import { renderEquipesPublicPage } from './pages/equipes.js?v=20260916d';
import { renderResultadosPage } from './pages/resultados.js?v=20260916d';
import { renderRankingPage } from './pages/ranking.js?v=20260916d';
import { renderSobrePage } from './pages/sobre.js?v=20260916d';
import { renderTermosPage } from './pages/termos.js?v=20260916d';
import { renderRegulamentoPage } from './pages/regulamento.js?v=20260916d';
import { renderRegulamentosAdminPage } from './pages/admin/regulamentos.js?v=20260916d';
import { renderTvVideosAdminPage } from './pages/admin/tv_videos.js?v=20260916d';
import { renderMinhasInscricoesPage } from './pages/minhas_inscricoes.js?v=20260916d';
import { loginUser, logoutUser, currentUser, authResolved } from './auth.js?v=20260916d';
import { seedInitialData, getCollectionCount } from './services/db.js?v=20260916d';
